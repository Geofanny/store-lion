...
<body class="sb-nav-fixed" style="background-color:  white">
    ...
    <div id="layoutSidenav_content">
        <main>
                ...
                <h1 class="mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            style="background-color: #0CCDA3;">
                            <div class="card-body">
                                <i class="fas fa-archive fa-5x" 
                                style="float: right;opacity: 0.8;padding-top: 3vh;">
                            </i>
                            <h3>Produk</h3>
                            <h3>11</h3>
                        </div>
                        <div class="small text-white mb-4">
                            <a class="small text-white stretched-lin" 
                            href="#">
                        ...
                        <i class="fas fa-angle-right"></i>
                               ...
                               {{--  <div class="card-footer d-flex align-items-center justify-content-between ml-4">
                                   <i class="fas fa-archive ml-4"></i>
                               </div> --}}
                           </div>
                       </div>
            ...
            <div class="card mb-4 bg-light" style="box-shadow:3px 3px 3px grey ">
                <div class="card-header">
