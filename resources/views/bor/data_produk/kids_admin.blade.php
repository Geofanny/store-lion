...
<div class="row">
	<div class="col-md-12">
		<div id="jewellery" class="Jewellery-bg">
			<h3><img src="images/bby.png" width="50">
				<span>Kids and Babies
		...
		<div class="row">
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
				<div class="Jewellery-box">
					<h5>Sale</h5>
					<i><img src="{{ asset('img/produk') }}/k1.png"/>
					</i>
					<h4>Children's Shoes  <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/y1.png"/></i>
					<h4>Baby Clothes  <span class="nolmal" style="color: red">$100</span></h4>                                        </div>
					<div class="mb-4">
						<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
							Edit
						</button>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
					<div class="Jewellery-box">
						<i><img src="{{ asset('img/produk') }}/y2.png"/></i>
						<h4>Baby Milk Bottle  <span class="nolmal" style="color: red">$100</span></h4>                                        </div>
						<div class="mb-4">
							<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
								Edit
							</button>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
						<div class="Jewellery-box">
							<i><img src="{{ asset('img/produk') }}/y3.png"/></i>
							<h4>Baby Toys  <span class="nolmal" style="color: red">$100</span></h4>                                        </div>
							<div class="mb-4">
								<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
									Edit
								</button>
