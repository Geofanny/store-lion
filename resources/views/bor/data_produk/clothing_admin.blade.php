	...
	<div class="col-md-12 ">
		<div id="Electronics" class="Jewellery-bg mt-3">
			<h3 style="margin-top: 40px">
				<i class="fas fa-tshirt mt-4 mr-2"></i>
				<span>Clothing
					<button type="button" class="btn btn-success" 
					style="float:right; margin-top: 20px; width: 190px;" data-bs-toggle="modal" data-bs-target="#exampleModal2">
		...
		<div class="row" >
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
				<div class="Jewellery-box ">
					<h5>Sale</h5>
					<i><img src="{{ asset('img/produk') }}/p1.png"/>
					</i>
					<h4>T-Shirt Red  <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/p2.png"/></i>
					<h4>T-Shirt Blue <span class="nolmal" style="color: red"> $100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
						Edit
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/p4.png"/></i>
					<h4>T-Shirt Yellow  <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
						Edit
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/kimono.png"/></i>
					<h4>Men`s Kimono <span class="nolmal" style="color: red">
					$ 100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
		...
		<div class="row">
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/piyama.png"/>
					</i>
					<h4>Night Gown  <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
						Edit
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/an.png"/></i>
					<h4>Children <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
						Edit
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/sweter.png"/></i>
					<h4>Sweater Cute <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
						Edit
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
				<div class="Jewellery-box">
					<i><img src="{{ asset('img/produk') }}/nel.png"/></i>
					<h4>Shirt Flanel <span class="nolmal" style="color: red">$100</span></h4>
				</div>
				<div class="mb-4">
					<button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 290px">
						Edit
