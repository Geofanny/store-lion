		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/electronic.html">Electronic</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/shoes.html">Shoes</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/jam.html">Watches</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/cincin.html">Jewellery</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/makeup.html">Beauty</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/kids.html">Kids</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/sport.html">Sport</a>
					</li>
					<li class="nav-item mx-3">
						<a class="nav-link" href="barang/clothing.html">Garden</a>
					</li>
